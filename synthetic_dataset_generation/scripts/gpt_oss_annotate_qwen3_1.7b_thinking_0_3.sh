...
#SBATCH --job-name=gpt_oss_annotate_qwen3_1.7b_thinking_0_3
#SBATCH --output=gpt_oss_annotate_qwen3_1.7b_thinking_0_3.out
#SBATCH --error=gpt_oss_annotate_qwen3_1.7b_thinking_0_3.err
...
VLLM_LOG="vllm_gpt_oss_120b_0_3.log"
SHARDS="0 1 2 3"
SHARDS_TAG="0_3"
DEBUG=0
TIMEOUT=600
