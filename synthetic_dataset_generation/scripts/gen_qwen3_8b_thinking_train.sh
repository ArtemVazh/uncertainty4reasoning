...
#SBATCH --job-name=gen_qwen3_8b_thinking_train
#SBATCH --output=gen_qwen3_8b_thinking_train.out
#SBATCH --error=gen_qwen3_8b_thinking_train.err
...
SAVE_PATH="${ROOT}/uncertainty4reasoning/gen_data/train_prm800k_qwen3_8b_thinking_texts"
