...
from bestofn_stepwise.stat_calculators.stepwise_prm_minimization import StepwisePRMMinimizationCalculator
...
def main(args):
    ...
    update_stats(stats, [StepwisePRMMinimizationCalculator(args.prompt_file)], model, args.save_path)
